...
/*
 Algorithm Used: here if the count bit is not same we have to change
 so if we want to get the number we have to xor so that after xor we can find the number
*/
#include <bits/stdc++.h>
using namespace std;
