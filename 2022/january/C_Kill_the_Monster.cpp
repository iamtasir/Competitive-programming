...
int main()
{
    ...
    while (t--)
    {
        ...
        ll chealth, cattack, mhealth, mattack, k, w, a;
        cin >> chealth >> cattack >> mhealth >> mattack >> k >> a >> w;
        ll c = 0;
        chealth -= 1;
        for (ll i = 0; i <= k; i++)
        {
            ...
            // debug(x);
            ll k1 = k - i;
            ll tempcattack = (i * a) + cattack;
            ll tempchealth = chealth + k1 * w;
            ll attack1 = (mhealth + tempcattack - 1) / tempcattack;
            debug(attack1);
            ll health1 = (tempchealth) / mattack;
            debug(health1);

            if (health1 + 1 >= attack1)
            {
                c = 1;
                break;
            }
