...
ll n;
string s;
ll cost1(ll start, ll end, char c)
{
    ll cnt = 0;
    string s1;
    if (start == 0 || end == 0)
...
int main()
{
    ...
    while (t--)
    {
        ...
        s1 += s;
        s = s1;
        ll leftcost = cost1(1, n / 2, 'a');
        leftcost += min(cost1(n / 2 + 1, n / 2 + n / 4, 'b') + cost1(n / 2 + n / 4 + 1, n, 'c'), cost1(n / 2 + 1, n / 2 + n / 4, 'c') + cost1(n / 2 + n / 4 + 1, n, 'b'));
        ll rightcost = cost1(n / 2 + 1, n, 'a');
        rightcost += min(cost1(1, n / 2 - n / 4, 'b') + cost1(n / 2 - n / 4 + 1, n / 2, 'c'), cost1(1, n / 2 - n / 4, 'c') + cost1(n / 2 - n / 4 + 1, n / 2, 'b'));
        debug(n / 2 + 1);
        debug(n / 2 + n / 4);
        debug(n / 2 - n / 4);

        cout << min(leftcost, rightcost) << nn;
    }
