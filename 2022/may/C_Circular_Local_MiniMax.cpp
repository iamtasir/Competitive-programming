    ...
    while (t--)
    {
        ...
        for (ll i = 0; i < n; i++)
        {
            if (i == 0)
            {
                ...
                if (v3[i] > v3[n - 1] && v3[i] > v3[i + 1])
                    cnt++;
                else if (v3[i] < v3[n - 1] && v3[i] < v3[i + 1])
                    cnt++;
                // debug(v3[n - 1]);
                // debug(cnt);
            }
            ...
            {
                // debug(cnt);
                if (v3[i] > v3[i - 1] && v3[i] > v3[0])
                    cnt++;
                else if (v3[i] < v3[i - 1] && v3[i] < v3[0])
                    cnt++;
                // debug(v3[0]);
                // debug(v3[i]);
                // debug(v3[i - 1]);
            ...
            else if (v3[i] > v3[i - 1] && v3[i] > v3[i + 1])
                cnt++;
            else if (v3[i] < v3[i - 1] && v3[i] < v3[i + 1])
                cnt++;
            debug(cnt);
