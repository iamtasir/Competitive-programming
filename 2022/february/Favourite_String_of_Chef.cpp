...
int main()
{
    ...
    while (t--)
    {
        ...
        for (ll i = 0; i < n; i++)
        {
            if (st[i] == s2[0] && st[i + 1] == s2[1] && st[i + 2] == s2[2] && st[i + 3] == s2[3] && cnt == 0)
            {
                x = 1;
                break;
            }
            if (st[i] == s1[0] && st[i + 1] == s1[1] && st[i + 2] == s1[2] && st[i + 3] == s1[3] && cnt == 0)
            {
                cnt = 1;
                i += 3;
                string x = "in";
            ...
            else if (st[i] == s2[0] && st[i + 1] == s2[1] && st[i + 2] == s2[2] && st[i + 3] == s2[3] && cnt == 1)
            {
                cnt = 2;
                break;
            }
