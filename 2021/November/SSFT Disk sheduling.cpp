...
void shortestSeekTimeFirst(int request[], int head, int n)
{
    ...
    seeksequence[n] = head;
    cout << "Total number of seek operations = " << seekcount << nn;
    cout << "Seek sequence is : "
         << "\n";
    for (int i = 0; i <= n; i++)
    {
        cout << seeksequence[i] << ss;
    }
    cout << nn;
}
...
int main()
{
    ll n, initialheadposition;
    cin >> n >> initialheadposition;
    for (ll i = 0; i < n; i++)
        cin >> ar[i];

    shortestSeekTimeFirst(ar, initialheadposition, n);
