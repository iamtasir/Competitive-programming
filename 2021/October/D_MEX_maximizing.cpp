...
/*
 Algorithm Used:implementation help yash daga
 idea by me
*/
#include <bits/stdc++.h>
using namespace std;
...
int main()
{
    ...
    while (q--)
    {
        ...
        mp.erase({b, a});
        mp[{b + 1, a}]++;
        ll freq = mp.begin()->first.ff;
        ll value = mp.begin()->ff.sc;
        cout << (freq)*md + value << nn;
        mp1[a]++;

        // mp.erase()
        // debug(mp);
        //  cout << min(0ll, mp.begin()->sc - 2) * mp.begin()->ff + mp.begin()->ff << nn;
    }
